require "fog/core"
require "fog/json"
require File.expand_path("../brightbox/version", __FILE__)
...
module Fog
  module Compute
    autoload :Brightbox, File.expand_path("../compute/brightbox", __FILE__)
  end

  module Storage
    autoload :Brightbox, File.expand_path("../storage/brightbox", __FILE__)
  end
